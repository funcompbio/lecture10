...
* The software _make_ and _Makefiles_ are still nowadays intensively used in
  ...
  &nbsp;&nbsp;
* Likewise, _make_ and _Makefiles_ can be to automate data analysis pipelines;
  see the blog post ["Why Use Make"](https://bost.ocks.org/mike/make) by
