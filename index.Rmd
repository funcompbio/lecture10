...
* [GitHub Copilot](https://github.com/copilot) is an AI-powered coding assistant
  ...
  &nbsp;&nbsp;
* It is powered by OpenAI's [generative pre-trained transformer model (GPT)](https://en.wikipedia.org/wiki/Generative_pre-trained_transformer)
...
* Writing code as you normally would, and GitHub Copilot will provide
  ...
  written.  
  &nbsp;&nbsp;
* Context or more specific prompts can be provided to GitHub Copilot by
...
.pull-left[
* AI pair programming with tools like GitHub Copilot can help you writing code
  more efficiently, improve code quality, and enhance your learning experience,
  helping you to keep the dev flow.  
]
.pull-right[
<p style="margin-top:0px;">
![:scale 50%](img/GHCopilotIcon.png)
]
...
* It is important to use AI pair programming tools responsibly and
  ...
  &nbsp;&nbsp;
* To make the best of AI pair programming tools you need to learn to do good
