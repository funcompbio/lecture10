...
* The observer detects errors, makes suggestions, and thinks strategically
...
.pull-left[
* It is a new approach to pair programming in which an
  AI-powered coding assistant helps a human programmer to write code.  
  &nbsp;&nbsp;
...
* The AI assistant can help the human programmer by suggesting code snippets,
  ...
  scripts based on the human's requirements.
...
* [GitHub Copilot](https://github.com/copilot) is an AI-powered coding assistant
  ...
  &nbsp;&nbsp;
* It is powered by OpenAI's [ChatGPT-Codex](https://chatgpt.com/codex),
  an LLM trained on a vast corpus of public code repositories and natural
  language text.  
  &nbsp;&nbsp;
...
* The [main features](https://docs.github.com/en/copilot/get-started/what-is-github-copilot)
  of GitHub Copilot include:
...
* The two main differences between GitHub Copilot and other
  general-purpose LLMs such as ChatGPT or Gemini are:
