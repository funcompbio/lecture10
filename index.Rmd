...
* Next to the comments you write in your code, you can customize Copilot's
  ...
  in a markdown file called `copilot-instructions.md` in the root of your
  project, opening a folder in VS Code.  
  &nbsp;&nbsp;
...
* **Responsibility:** You are responsible for the content of your project,
  including content generated with the help of AI tools. If that content is
  not correct, your grade will reflect that, even if the content was generated
  by an AI tool.  
  &nbsp;&nbsp;
* **Transparency:** You should document the use of AI tools in assignments
  and projects. Failure to do so will be considered a breach of academic
  integrity and will be penalized accordingly.  
  &nbsp;&nbsp;
* **Learning:** You should understand the content generated with the help of
  AI tools. If you use an AI tool to generate code, you should be able to
  explain how that code works and why it is correct. You should **not** use
  AI tools to outsource your brain and learning experience.
